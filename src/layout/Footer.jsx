...
const socialLinks = [
  { icon: Github, href: "https://github.com/rohit-pilore", label: "GitHub" },
  {
    icon: Linkedin,
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            <a href="#" className="inline-block hover:text-primary transition-colors group">
              <img src="/rob-logo-removebg-preview.png" alt="ROB Logo" className="w-16 h-16 object-contain group-hover:scale-110 transition-transform" />
            </a>
            <p className="text-sm text-muted-foreground mt-2">
              © {currentYear} Rohit Pilore. All rights reserved.
            </p>
          </div>
          ...
          {/* Social Links */}
          <ul className="social-icons-list scale-90">
