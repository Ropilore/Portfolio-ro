  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-5xl mb-4 text-white max-w-4xl font-bold">
          Career Journey
        </h2>
        <p
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-muted-foreground/30 ">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3
                className="md:hidden block text-2xl mb-4 text-left font-bold text-muted-foreground/30">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary via-primary/50 to-transparent from-[0%] via-[10%] rounded-full shadow-[0_0_15px_rgba(32,178,166,0.5)]" />
        </div>
      </div>
    </div>
  );
